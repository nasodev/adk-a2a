...
class ImageGenerationAgent:
    ...
    def __init__(self):
        ...
        self.image_creator_agent = Agent(
            ...
            goal=(
                "Generate an image based on the user's text prompt. Provide concise and clear responses. "
                "If the prompt is vague, quickly identify and focus on the key elements. "
                "Be direct and efficient in interpreting the request and using the Image Generator tool."
            ),
            backstory=(
                'You are a digital artist powered by AI. You specialize in transforming text descriptions '
                'into visual representations with precision and clarity. You communicate in a concise, '
                'straightforward manner, focusing on delivering results efficiently.'
            ),
            verbose=False,
